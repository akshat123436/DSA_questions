...
void _print(set<int>&arr){for(auto a:arr)cerr<<a<<" ";cerr<<endl;}
void _print(set<pair<int,int>>&arr){for(auto a:arr)cerr<<"("<<a.first<<","<<a.second<<")  ";cerr<<endl;}


// Unordered Map

template<class G>
void _print (um<G,G> x)    { cerr<<endl;   for(auto a:x){  cerr<<"("<<a.first<<","<<a.second<<")";    }   cerr<<endl;     }


// Map
template<class G>
void _print (map<G,G> x)    { cerr<<endl;   for(auto a:x){  cerr<<"("<<a.first<<","<<a.second<<")";    }   cerr<<endl;     }


// Vector
void _print(vector<pair<int,int> > & arr){fori(0 , arr.size() , 1){cerr<<"("<<arr[i].first<<","<<arr[i].second<<") ";}cerr<<endl;}
...
tt{
    ...
    vi rgb(n+1 , 0) , gbr(n+1  ,0) , brg(n+1 ,0);
